...
class DCMotor(object):
    def __init__(self, verbose:bool=False, pins:list=(15,14,18), pwm:bool=True, rgbLED:RGB_Indicator=RGB_Indicator(enable=True, verbose=True, red_pin=23, green_pin=24, blue_pin=25)):
...
class IntakeMotor(DCMotor):
    def __init__(self, verbose: bool = False, pins: list = (15, 14, 18), pwm: bool = True, rgbLED: RGB_Indicator = RGB_Indicator(enable=True, verbose=True, red_pin=23, green_pin=24, blue_pin=25)):
        super().__init__(verbose, pins, pwm, rgbLED)
